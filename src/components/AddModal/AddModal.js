...
const AddModal = ({
  ...
  <Transition visible={openModal} animation="fly down" duration={600}>
    <Modal open={openModal}>
      <Modal.Header>Ajouter {currentDisheName} </Modal.Header>
      <Modal.Content>
        <Form
          error={postError}
          onSubmit={(e) => {
        ...
        >
          ...
          {currentDisheName === 'Vins' && (
            <>
              <Form.Field>
                <label htmlFor="wineRegion">Region du Vin</label>
                <Input
                  id="wineRegion"
...
AddModal.propTypes = {
  ...
  disheCategory: PropTypes.oneOfType([PropTypes.string, PropTypes.array])
    .isRequired,
